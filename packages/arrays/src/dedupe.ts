 ...
 */
export const dedupeArray = <T extends string | number | symbol | boolean>(arr: readonly T[]) => {
	return [...new Set(arr)];
};
 ...
 */
export const dedupeArrayOfObjects = <T extends Record<string | number | symbol, unknown>>(
	arr: readonly T[],
	filterKey: string
) => {
